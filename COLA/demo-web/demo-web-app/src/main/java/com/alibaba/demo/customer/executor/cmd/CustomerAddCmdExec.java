...
package com.alibaba.demo.customer.executor.cmd;

import com.alibaba.cola.dto.Response;
import com.alibaba.cola.exception.BizException;
import com.alibaba.demo.cmd.CustomerAddCmd;
import com.alibaba.demo.dto.ErrorCode;
import org.springframework.stereotype.Component;


@Component
public class CustomerAddCmdExec {

    public Response execute(com.alibaba.demo.cmd.CustomerAddCmd cmd) {
